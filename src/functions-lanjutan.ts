...
function cariPeserta(data: number | string): Peserta | undefined {
...
console.log(
  urutkanPeserta(daftarPeserta, (a, b) => a.nilai - b.nilai)
);

console.log("\nUrut Nilai Descending");
console.log(
  urutkanPeserta(daftarPeserta, (a, b) => b.nilai - a.nilai)
);
